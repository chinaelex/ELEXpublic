Pod::Spec.new do |s|
  ...
  s.source   = { :git => 'https://git.elex-tech.com/opt-connect/open-ios/epsdkmasonry.git', :tag => "v#{s.version}" }
  ...
  s.source_files = 'EPSDKMasonry/*.{h,m}'

  s.ios.frameworks = 'Foundation', 'UIKit'
#  s.tvos.frameworks = 'Foundation', 'UIKit'
#  s.osx.frameworks = 'Foundation', 'AppKit'

  s.ios.deployment_target = '10.0' # minimum SDK with autolayout
